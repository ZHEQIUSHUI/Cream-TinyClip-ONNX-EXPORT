...
with torch.no_grad(), torch.cuda.amp.autocast():
    ...
    # torch.onnx.export(model,image,"res19m.img.onnx",opset_version=14,input_names=["images"],output_names=["image_features"])
    torch.onnx.export(model,text,"res19m.text.onnx",opset_version=14,input_names=["texts"],output_names=["text_features"],dynamic_axes={"texts":{0:"num_texts"}})
